...
- A running OpenRemote instance — see the [Quick Start](../docs/quick-start).
...
See [Auto provisioning devices and users](../docs/user-guide/gateways-and-devices/auto-provisioning) for the message format and the full configuration reference.
...
For a concrete firmware example, follow [Connect ESP32 or ESP8266 using MQTT](../docs/user-guide/gateways-and-devices/connect-esp32-or-esp8266-using-mqtt), then point it at your provisioning config instead of a manually created service user.
